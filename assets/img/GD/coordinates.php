...
class Character extends DOMDocument
{
    ...
    public $default = [
        0 => ['coat' => 1040036, 'pants' => 1060026],
        1 => ['coat' => 1041046, 'pants' => 1061039],
    ];
    ...
    public function setCap($z)
    {
        $zArray = [ // Updated
            ...
            'accessoryEar'				         => ['default', 'defaultB'], //only 01003108
            ...
            foreach ($zArray[$z] as $type) {
                ...
                if (property_exists($this->Cap['xml'], $cap)) {
                    if ($this->Cap['xml']->$cap->stand1->z == $z) {
                        ...
                        } elseif (self::exists('Cap/0'.$this->Cap['ID'].'.img/stand1.0.'.$type.'.png')) {
    ...
    public function setShield($z = null)
    {
        ...
        } elseif ($this->Shield['ID'] > 1340000 && $this->Shield['ID'] < 1360000) { // Secondary weapon
            // not handle secondary weaps by this way anymore
        } elseif (isset($this->Shield['xml']) && $z == null) {
    ...
    {
        $canvasArray = [
            'r' => ['stand1' => ['rGlove', 'rWrist', 'gloveOverHead'], 'stand2' => ['rGlove', 'rWrist']],
            'l' => ['stand1' => ['lGlove', 'lWrist', 'gloveOverBody'], 'stand2' => ['lGlove', 'lWrist', 'gloveOverHand', 'lGlove2']],
        ];
